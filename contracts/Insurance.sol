...
contract InsuranceAgent is FunctionsClient {
    ...
    function requestInsurance(uint256 loanAmount, uint256 btcPurchasePrice) external payable {
        ...
        req._addDONHostedSecrets(0, 1749607453); // secret slot indices
